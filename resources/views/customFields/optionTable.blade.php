...
<div class="card-body table-responsive" id="fieldOptions" data-fieldid="{{ $field_id }}">
    <table id="data_table" class="table table-bordered table-striped table-hover dataTable w-100">
        ...
        <tr>
            ...
            <th>{{ __('theme.value') }}</th>
            <th class="text-center">{{ __('theme.actions') }}</th>
        </tr>
        </thead>
    </table>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="modal-header">
                <h5 class="modal-title">{{ __('theme.edit_custom_field_option') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-success alert-dismissible fade show" role="alert" style="display: none;">
                    <strong>{{ __('theme.success') }} </strong>{{ __('theme.custom_field_updated_successfully') }}.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="SubmitEditOptionFieldForm">{{ __('theme.update') }}</button>
...
<div class="modal" id="DeleteOptionFieldModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="SubmitDeleteCustomFieldForm">{{ __('theme.yes') }}</button>
