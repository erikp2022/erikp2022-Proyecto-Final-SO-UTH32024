...
@section('title', __('theme.add_new_staff'))

@section('main-section')
    <div class="container-fluid">
        @if($permission->manageStaff() == 1)
        <h4 class="page-title">{{ __('theme.add_new_staff') }}
            <a href="{{ route('staffs.staffList') }}" class="btn btn-primary pull-right">{{ __('theme.back') }}</a>
        </h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form role="form" class="" method="POST" action="{{ route('save-staff.saveStaff') }}">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="role_id">{{ __('theme.role') }}</label>
                                        <select id="role_id" type="" class="form-control" name="role" required>
                                            <option value="">{{ __('theme.select_role') }}</option>
                            ...
                            <div class="box-footer mb-3">
                                <button type="submit" class="btn btn-primary btn-block">{{ __('theme.add_staff') }}</button>
                            </div>
                        </div>
                        <!-- /.box-body -->
                    </form>
